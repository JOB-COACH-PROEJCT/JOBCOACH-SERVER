package org.v1.job_coach.security.jwt;
...
/*    @Value("${springboot.jwt.secret}")
    private String secretKey;  -> 오류 개뜨니까 일단 주석처리 */
    private Key key;
    ...
    protected void init() {
        ...
        // secretKey를 사용하는 대신 적절한 길이의 비밀 키를 생성
        key = Keys.secretKeyFor(SignatureAlgorithm.HS256); // 추가된 코드
